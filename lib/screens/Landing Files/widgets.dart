// //ignore_for_file: import_of_legacy_library_into_null_safe, unused_field, must_be_immutable, non_constant_identifier_names, prefer_typing_uninitialized_variables, avoid_print, camel_case_types, prefer_const_constructors, use_build_context_synchronously, unrelated_type_equality_checks
...
//     if (Data != null || Data != []) {
//       Data.removeWhere((item) => item['sentby'] == item['sentto']);
//       // // ignore: unused_local_variable
//       Data.removeWhere((item) =>
//           item['message_id'] == "undefined" || item['sentto'] == "undefined");

//   // Data.forEach((e) {
//   //   toRemove.putIfAbsent("$e", () =>
//   //   test.add(e));
...
//   // print("-------print-------------${toRemove.keys.toList()}");

//   // print("-------lengthtest-------------${toRemove.length}");
...
//           print("55555555555${recentchatmsg}");
...
//       print("--mom--");
//       return value;
//     } else if (filetype == "mp3" && value == 'audio') {
//       print("--mp3--");
//       return value;
...
//     var Data = await FilePicker.platform.pickFiles(allowMultiple: false);
...
//     );
//     var path = Data!.files.first.path;
//     var name = Data.files.first.name;
...
//   @override
//   Widget build(BuildContext context) {
//     print("++++++++contactlength++++++++++++${contactList.length}");
//     return FutureBuilder(
//       future: Future.delayed(const Duration(seconds: 5)),
//       builder: ((context, snapshot) {
...
class _ChatListState extends State<ChatList> {
  ...
  LoadData() async {
   ...
   Data.removeWhere((item) => item['sentby'] == item['uid']);

    Data.removeWhere((item) =>
        item['message_id'] == "undefined" ||
        item['sentto'] == "undefined" ||
        item['sentby'] == "undefined");
